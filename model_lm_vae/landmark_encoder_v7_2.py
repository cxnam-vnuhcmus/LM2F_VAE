...
from .blocks import SPADE, AdaptiveMouthEnhancement, convert_flow_to_deformation, make_coordinate_grid, warping
...
class FusionModel(nn.Module):
    def __init__(self, n_target_frame=5, n_ref_frame=3):
        ...
        self.ame_layer_4 = AdaptiveMouthEnhancement(24, 4*self.n_ref_frame)
        self.spade_layer_5 = SPADE(24, 8, 32)
        self.ame_layer_5 = AdaptiveMouthEnhancement(24, 4*self.n_ref_frame)
    ...
    def forward(self, mask_gt_img_feature, gt_lm_feature, ref_img_feature, ref_lm_feature): #(B,N,4,32,32)
        ...
        x = self.ame_layer_4(x, ref_img_feature)
        x = self.spade_layer_5(x, wrapped_spade_sum)
        x = self.ame_layer_5(x, ref_img_feature)
