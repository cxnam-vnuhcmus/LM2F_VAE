...
class Dataset(td.Dataset):
    ...
    def __getitem__(self, idx):        
        ...
        return (lm_feature, gt_img_feature, gt_img_mask_feature, None, vs_path)
    ...
    def collate_fn(self, batch):
        ...
        return batch_landmark, batch_gt_img_feature, batch_gt_mask_img_feature, None, batch_vs_path
