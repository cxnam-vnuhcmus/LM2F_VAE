...
class CustomLoss(nn.Module):
    ...
    def forward(self, pred, target, pred_lm=None, gt_lm=None):
        ...
        total_loss = self.alpha * mse_loss + self.beta * kd_loss #+ self.gamma * bce_loss
        return total_loss
