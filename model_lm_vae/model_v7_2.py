...
from .landmark_encoder_v7_2 import FusionModel
from .visual_encoder import VisualEncoder
from .loss import VGG19FeatureExtractor, perceptual_loss

#DS_V8 LM_V7_2 AdaptiveMouthEnhancement
class Model(nn.Module):
    ...
    def loss_function(self, pred_feature, gt_feature, pred_img, gt_img, pred_lm, gt_lm):
        ...
        attn_loss = self.attention_loss_fn(pred_feature[:, :, :, 4*4:7*4, 2*4:6*4], gt_feature[:, :, :, 4*4:7*4, 2*4:6*4])
